...
pub const HANDOFF_INSTRUCTION_MAX_CHARS: usize = 600;
pub const HANDOFF_CHANGED_PATHS_MAX_ITEMS: usize = 12;
...
pub fn build_handoff_brief(input: HandoffBriefInput<'_>) -> Value {
